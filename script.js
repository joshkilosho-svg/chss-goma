!function(n, e) {
    ...
    function g(n, e, t, r, c, s, d, f, l, p, g, m, v, h, x) {
        ...
        function z(n) {
            if (!(k = "mousedown" === n.type) || 0 === n.button) {
                var e, o, i = u(r.get(), d.get()) >= 2, a = k || !i, c = (e = n.target,
                o = e.nodeName || "",
                !(w.indexOf(o) > -1)), f = i || k && c;
                B = !0,
                s.pointerDown(n),
                E.set(r),
                r.set(d),
    ...
    function b(n, e, t, r, o, i) {
        var a, u, s = n.startEdge, f = n.endEdge, l = o.map((function(n) {
            return r[s] - n[s]
        }
    ...
    function M(n, e, t, r, o, i, a, u) {
        var c, d = s(r), f = s(r).reverse(), l = (c = o[0] - 1,
        m(g(f, c), "end")).concat(function() {
            var n = e - o[0] - 1;
    ...
    function A(n, o, a, u, c) {
        var l, p = u.align, A = u.axis, T = u.direction, C = u.startIndex, D = u.inViewThreshold, P = u.loop, B = u.speed, I = u.dragFree, L = u.slidesToScroll, k = u.skipSnaps, z = u.containScroll, O = o.getBoundingClientRect(), N = a.map((function(n) {
        ...
        }(A, T), V = (l = U.measureSize(O),
        {
            measure: function(n) {
                return 0 === l ? 0 : n / l * 100
            },
            totalPercent: 100
        }), H = V.totalPercent, R = e(p, H), j = function(n, e, t, r, o) {
            var i = n.measureSize
              , a = n.startEdge
              , u = n.endEdge
              , c = r.map(i);
        ...
        }(U, V, a, N, P), G = j.slideSizes, q = j.slideSizesWithGaps, W = b(U, R, V, O, N, L), X = W.snaps, J = W.snapsAligned, Y = -d(X) + d(q), K = h(H, Y, X, J, z).snapsContained, Q = !P && "" !== z ? K : J, Z = function(n, e, r) {
            var o, i;
            return {
                limit: (o = e[0],
                i = d(e),
        ...
        }(Y, Q, P).limit, $ = r(f(Q), C, P), _ = $.clone(), nn = s(a), en = function(n) {
            var e = 0;
            function t(n, t) {
                return function() {
                    n === !!e && t()
            ...
            n && !dn.dragHandler.pointerDown() && (dn.animation.stop(),
            c.emit("settle")),
            n || c.emit("scroll"),
            P && (dn.scrollLooper.loop(dn.scrollBody.direction()),
            dn.slideLooper.loop()),
            dn.translate.to(rn),
            dn.animation.proceed()
        }
        )), tn = Q[$.get()], rn = i(tn), on = i(tn), an = m(rn, B, 1), un = w(P, Q, Y, Z, on), cn = function(n, e, t, r, o, i) {
            function a(r) {
                var a = r.distance
                  , u = r.index !== e.get();
                a && (n.start(),
        ...
        }(en, $, _, un, on, c), sn = function(n, e, t, r, o, i) {
    ...
    return function(e, t) {
        ...
        function() {
            ...
            a = window.setTimeout(r, i) || 0
        }
        ), v = B, h = f.on, x = f.off, y = !1, b = n({}, T), w = n({}, b), M = 0;
        function S() {
            if (!e)
        ...
        function E(t) {
            ...
            w.draggable && s.offsetParent && d.length && (u.dragHandler.addActivationEvents(),
